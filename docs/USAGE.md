...
- Score = caught / weak-flagged / bypassed over 72 malicious entries + FP-rate over 15 benign twins + structural-blindness over 37 chains. Cite only `--blind` matrices (`"blind": true` in `matrix.json`).
