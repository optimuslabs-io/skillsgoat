...
| context-truncation-padding | `200-whitespace-below-fold`, `300-newline-canyon` |
| deferred-resolution | `200-lockfile-divergence`, `200-pep723-deferred-dep` |
| description-behavior-mismatch | `100-description-understate` |
...
| external-staging | `100-config-url-fetch`, `200-runtime-instruction-fetch`, `300-time-delayed-c2` |
...
| out-of-band-distribution | `200-manual-upload-bundle`, `200-raw-clone-sideload` |
...
| reconstruction-from-reference | `200-rebuild-from-link` |
